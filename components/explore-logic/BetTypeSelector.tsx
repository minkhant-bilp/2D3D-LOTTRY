...
export default function BetTypeSelector() {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.sectionTitle}>{t('bet_type.section_title', 'SELECT GAME') as string}</Text>
                                        ...
                                        <View style={[styles.innerCard, pressed && styles.innerCardPressed]}>
                                            ...
                                            <View style={styles.textContainer}>
                                                <Text style={styles.label}>
                                                    {t(`bet_type.${type.toLowerCase()}_label`, label) as string}
                                                </Text>
                                                <Text style={styles.caption}>
                                                    {t(`bet_type.${type.toLowerCase()}_caption`, caption) as string}
                                                </Text>
                                            </View>
                                        </View>
                                    </View>
...
const styles = StyleSheet.create({
    ...
    iconWrapper: { alignItems: 'center', justifyContent: 'center', marginBottom: 12, height: 60 },
    textContainer: { alignItems: 'center', justifyContent: 'center' },
    label: { color: '#f7f9ff', fontSize: 18, fontWeight: 'bold', marginBottom: 4, textAlign: 'center' },
    caption: { color: '#8a9bb3', fontSize: 10, textAlign: 'center', lineHeight: 14 },
});