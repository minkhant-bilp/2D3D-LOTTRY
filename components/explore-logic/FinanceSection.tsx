...
export default function FinanceSection() {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.sectionTitle}>{t('finance.section_title', 'FINANCE') as string}</Text>
                                        ...
                                        <View style={[styles.innerCard, pressed && styles.innerCardPressed]}>
                                            ...
                                            <View style={styles.textContainer}>
                                                <Text style={styles.label}>
                                                    {t(`finance.${id}_label`, label) as string}
                                                </Text>
                                                <Text style={styles.caption}>
                                                    {t(`finance.${id}_caption`, caption) as string}
                                                </Text>
                                            </View>
                                        </View>
                                    </View>
...
const styles = StyleSheet.create({
    ...
    label: { color: '#f7f9ff', fontSize: 16, fontWeight: 'bold', marginBottom: 4, textAlign: 'center' },
